...
function defaultAuraCondition(kind: string): MechanicCondition {
  ...
  if (kind === "nexusBelow" || kind === "opponentNexusBelow" || kind === "manaAtLeast" || kind === "opponentManaAtLeast" || kind === "spellManaAtLeast" || kind === "opponentSpellManaAtLeast" || kind === "spellsCastAtLeast" || kind === "opponentSpellsCastAtLeast" || kind === "alliesSummonedAtLeast" || kind === "opponentAlliesSummonedAtLeast" || kind === "nexusDamageDealtAtLeast" || kind === "opponentNexusDamageDealtAtLeast" || kind === "handAtLeast" || kind === "opponentHandAtLeast" || kind === "roundAtLeast") return { kind, amount: 1 } as MechanicCondition;
  return { kind: "always" };
}
