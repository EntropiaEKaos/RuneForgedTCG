...
export type FxPresetId = "summon-default" | "attack-default" | "damage-default" | "heal-default" | "death-default" | "levelup-default" | "poison-default" | "barrier-default" | "frost-default" | "stun-default";
...
export function resolveGameEventFx(event: GameEvent): ResolvedFx | null {
  ...
  switch (event.type) {
    ...
    case "STATUS_REMOVED": return null;
  }
