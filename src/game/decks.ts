...
export const DECKS: DeckDef[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      "rfalpha_reanimator_dead_memory_thread", "rfalpha_reanimator_dead_memory_thread",
      "rfalpha_reanimator_second_pulse", "rfalpha_reanimator_second_pulse", "rfalpha_reanimator_second_pulse",
      "rfalpha_reanimator_last_vigil",
      "rfalpha_reanimator_seal_nothing", "rfalpha_reanimator_seal_nothing",
      "rfalpha_reanimator_drowned_mirror_lady", "rfalpha_reanimator_drowned_mirror_lady",
