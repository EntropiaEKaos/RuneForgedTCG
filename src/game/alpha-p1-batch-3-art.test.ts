...
import { ALPHA_P1_ACTIVE_IDS, ALPHA_P1_ART_FORMAT, ALPHA_P1_ART_TARGETS, ALPHA_P1_BATCH_3_IDS, alphaP1ArtUrl } from "./alpha-p1-art";
const expected=["forest_entangle","forest_stalker","wood_ent","wood_stag","wood_caller"] as const;
async function main(){
 const ids=[...ALPHA_P1_BATCH_3_IDS], targets=ALPHA_P1_ART_TARGETS.filter(t=>ids.includes(t.defId as any));
 ...
 assert.deepEqual(alphaArtBacklogSnapshot(),{starterDecks:6,starterSlots:240,uniqueStarterCards:140,covered:66,missing:74,byPriority:{P0:0,P1:31,P2:43}});
