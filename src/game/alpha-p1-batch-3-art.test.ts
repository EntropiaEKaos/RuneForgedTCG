...
async function main(){
 ...
 execFileSync(process.execPath,["--import","tsx","src/game/alpha-p1-batch-4-art.test.ts"],{cwd:process.cwd(),stdio:"inherit"});\n console.log("FORGED ALPHA P1 ART BATCH 3+4: Batch 3 masters preserved · Batch 4 chained · 71 covered / 69 backlog / 26 P1 pending / 43 P2 pending");
}
