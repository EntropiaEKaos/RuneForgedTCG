...
const FROZEN_VISUAL_BLOBS: Record<string, string> = {
  "src/app/layout.tsx": "c6407b6e294febb1721db1a649384697643bf915",
...
assert.ok(
  layout.indexOf(packOpeningLayer) > layout.indexOf(cosmeticPrestigeLayer),
  "Visual 5.7 Pack Opening premium must load after Visual 5.6 cosmetic prestige",
);
...
console.log("RUNE FORGE ALPHA VISUAL FEATURE FREEZE: 7 certified structural blobs PASS — Visual 5.7 pack opening break-glass recorded");
