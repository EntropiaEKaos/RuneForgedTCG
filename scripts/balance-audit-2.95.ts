...
if (enforce && certifiedGate !== "pass") {
  console.error(`RANKED BALANCE GATE 2.95: ${certifiedGate.toUpperCase()} (${health.criticalMatchups} critical, ${health.watchMatchups} watch, ${unstable.length} seed-sensitive)`);
  process.exitCode = 1;
}
