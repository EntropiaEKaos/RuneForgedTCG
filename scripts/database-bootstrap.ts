...
async function main() {
  try {
    ...
    try {
      ...
      console.log("DATABASE BOOTSTRAP 2.97 + PORTAL CMS + P2P MARKETPLACE + CARD COSMETICS + IDENTITY AUTH + FX PRESETS + FX ASSOCIATIONS + COLLECTOR SHOWCASE: PASS");
