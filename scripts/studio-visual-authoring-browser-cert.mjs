  ...
  try {
    ...
    const artEvidence = await evaluate(cdp, `(() => {
      ...
      return {
        ...
        coverage71:document.querySelector('[data-art-stat="com-arte"]')?.getAttribute('data-art-stat-value') || null,
        starterMissing69:document.querySelector('[data-art-stat="starter-sem-arte"]')?.getAttribute('data-art-stat-value') || null,
        p1Pending26:document.querySelector('[data-art-stat="p1-pendentes"]')?.getAttribute('data-art-stat-value') || null,
    ...
    assert.equal(artEvidence.coverage71, "71", "Art Pipeline must expose 71 cards with dedicated art after P1 Batch 4 activation");
    assert.equal(artEvidence.starterMissing69, "69", "Art Pipeline must expose 69 starter cards still missing dedicated art after P1 Batch 4 activation");
    assert.equal(artEvidence.p1Pending26, "26", "Art Pipeline must expose the remaining P1 queue of 26 after Batch 4 activation");
